...
public class HttpUtils {
	...
	//youfen
	public static HttpResponse doGet(String url, String method) throws Exception {
		//String host="";
	...
	public static HttpResponse doPost(String url,String method,Map<String, String> headers,Map<String, String> bodys) throws Exception, IOException {
	...
	public static void writeResponseWithUtf8(HttpServletResponse response, String str) {
