 ...
 */
@Entity
public class CourtJudgment extends BaseEntity {
    /**
     * 文书编号
     */
    ...
    public CourtJudgment(String docId, String title, String caseType, Date concludeTime, String content, CourtJudgmentPO belongTo) {
        this.docId = docId;
        this.title = title;
